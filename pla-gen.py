...
class MicroOp(Enum):
    IMM_MODE         = 0b00000000000001
    REG_B_TO_A       = 0b00000000000000
    MEM_TO_A         = 0b00000000000010
    ALU_TO_A         = 0b00000000000100
    AUX_TO_A         = 0b00000000000110
    MAR_CLEAR_ENABLE = 0b00000000001000
    MDR_CLEAR_ENABLE = 0b00000000010000
    REG_CLEAR_ENABLE = 0b00000000100000
    NEXT_INSTRUCTION = 0b00000001000000
    REG_WRITE_ENABLE = 0b00000010000000
    REG_READ_A = 0b00000100000000
    REG_READ_B = 0b00001000000000
    ALU_ENABLE = 0b00010000000000
    MAR_WRITE_ENABLE = 0b00100000000000
    MDR_WRITE_ENABLE = 0b01000000000000
    MDR_READ_ENABLE = 0b10000000000000
...
instructions = [
    ...
    Instruction(OpCode.BR, [MicroOp.REG_READ_A, MicroOp.IMM_MODE, MicroOp.NEXT_INSTRUCTION]),
    Instruction(OpCode.BRI, [MicroOp.REG_READ_A, MicroOp.REG_READ_B, MicroOp.NEXT_INSTRUCTION]),
    ...
    Instruction(OpCode.LIU, MicroOp.REG_CLEAR_ENABLE, [MicroOp.REG_WRITE_ENABLE, MicroOp.NEXT_INSTRUCTION])
]
...
with open("pla.txt", "w") as file:
    for instruction in instructions:
        ...
        if(instruction.clock0 != None):
            binary_string = format(combined_op, f"0{14}b")
