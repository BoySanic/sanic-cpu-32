...
Instruction("BGT", 37, [RegisterOperand(7), ImmediateOperand(12, 16, 0, False)])
Instruction("BLE", 38, [RegisterOperand(7), ImmediateOperand(12, 16, 0, False)])
...
Instruction("BGTU", 41, [RegisterOperand(7), ImmediateOperand(12, 16, 0, False)])
Instruction("BLEU", 42, [RegisterOperand(7), ImmediateOperand(12, 16, 0, False)])
...
Instruction("JGT", 53, [ImmediateOperand(12, 16, 0, True)])
Instruction("JLE", 54, [ImmediateOperand(12, 16, 0, True)])
Instruction("JLEU", 55, [ImmediateOperand(12, 16, 0, True)])
Instruction("JLTU", 56, [ImmediateOperand(12, 16, 0, True)])
Instruction("JGTU", 57, [ImmediateOperand(12, 16, 0, True)])
Instruction("JLEU", 58, [ImmediateOperand(12, 16, 0, True)])
...
Instruction("OR", 68, [RegisterOperand(7), RegisterOperand(12)])
Instruction("AND", 69, [RegisterOperand(7), RegisterOperand(12)])
...
Instruction("ORI", 84, [RegisterOperand(7), ImmediateOperand(12, 20, 0, False)])
Instruction("ANDI", 85, [RegisterOperand(7), ImmediateOperand(12, 20, 0, False)])
