...
REM
REM Generated by Vivado on Tue Dec 23 11:22:47 -0800 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_core_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_core_vlog.prj -log xvlog.log
